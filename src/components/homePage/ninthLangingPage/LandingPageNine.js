...
import playStore from '../../../assets/Link → playstore.png-1.svg';
        ...
        <div id="landing-page-nine">
            <div id='landing-page-nine-footer'>
                <div id='footer-1'>
                    ...
                    <p>Stuffin connects you to a world of home-cooked meals in Patna! Explore, subscribe & enjoy diverse tiffins from local providers, delivered with love & care to your doorstep.</p>
                </div>
                <div className='footer-2_3'>
                    <div id='footer-2' >
                        <h2>About Stuffin</h2>
                        <Link to='/blogs' className='footer-link' onClick={() => {// Reload the current page
                            localStorage.setItem('myData', "false");
                        }}>
                            <p>Blogs</p>
                        </Link>

                        <Link to='/rider' className='footer-link' onClick={() => {// Reload the current page
                            localStorage.setItem('myData', "false");
                        }} >
                            <p>FAQs</p>
                        </Link>

                        <Link to='/partner' className='footer-link' onClick={() => {// Reload the current page
                            localStorage.setItem('myData', "false");
                        }}>
                            <p>Contact us</p>
                        </Link>
                        <Link to='/about' className='footer-link' onClick={() => {// Reload the current page
                            localStorage.setItem('myData', "false");
                        }}>
                            <p>Help & Support</p>
                        </Link>
                    ...
                    <div id='footer-3' className='footer-link'>
                        ...
                        <Link to='/contact' className='footer-link' onClick={() => {// Reload the current page
                            localStorage.setItem('myData', "false");
                        }}>
                            <p>Ride with us</p>
                        </Link>
                ...
                <div className='footer-4_5'>
                    <div id='footer-4'>
                        ...
                        <Link to='/policy' className='footer-link' onClick={() => {// Reload the current page
                            localStorage.setItem('myData', "false");
                        }}>
                            <p>Terms & condition</p>
                        </Link>
                        ...
                        <Link to='/' className='footer-link' onClick={() => {// Reload the current page
                            localStorage.setItem('myData', "false");
                        }}>
                            <p>Cookie Policy</p>
                        </Link>
                    ...
                    <div id='footer-5'>
                        ...
                        <div id='social-media-icon'>
                            <a href='https://instagram.com/stuffin.in?igshid=MzMyNmU2YQ==' target='_blank'>
                                <img src={instaIcon} alt='/' />
                            </a>
                            <a href='https://www.facebook.com/profile.php?id=61552119961391&mibextid=9R9pXO' target="_blank">
                                <img src={fbIcon} alt='/' />
                            </a>
                            <a href='https://www.youtube.com/@Stuffin174?si=A0wTZHIifbxW_bD8' target='_blank'>
            ...
            <div id='footer-line'>
                <hr />
                <p>© 2023 Stuffin. All Rights Reserved. The contents of this website, including all text, graphics, logos, and other material are protected under both Indian and foreign copyrights, trademarks, and other laws. Unauthorized use of any content may violate copyright, trademark, and other laws. No reproduction or redistribution is permitted without the written permission of Stuffin.</p>
            </div>
        </div>
    )
}
